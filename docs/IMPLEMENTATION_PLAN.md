...
- Every view defaults to visibly explained **Triage order** and offers focus, activity, and organization sort modes suited to developer and support triage. **Status order** states that it follows configured lifecycle-status order and is mainly useful in the All view.
